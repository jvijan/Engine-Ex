...
enum INPUT_STATE {  INPUT_STATE_UP, INPUT_STATE_DOWN, INPUT_STATE_JUST_DOWN, INPUT_STATE_JUST_UP };
...
private:
  ...
  static inline std::unordered_map<SDL_Scancode, INPUT_STATE> keyboardStates;
...
public:
  ...
  static bool GetKeyLua(const std::string &keycode);
  static bool GetKeyDownLua(const std::string &keycode);
  static bool GetKeyUpLua(const std::string &keycode);
